...
const SummaryDisplay: React.FC<SummaryDisplayProps> = ({ 
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-10">
        ...
        <p className="text-sm text-gray-500">Generating detailed summary with AI...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-2">
      <div 
        ref={summaryRef}
        className="bg-gray-50 p-3 rounded-md border border-gray-200 text-sm text-gray-700 max-h-[300px] overflow-y-auto mb-2 markdown-content"
      >
        {!summary && <p className="text-gray-400">Summary will appear here...</p>}
      </div>
